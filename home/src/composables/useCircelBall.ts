import { UseCircelBall } from './types'

/**
 * 圆球
 */
export const useCircelBall = (option: UseCircelBall.Option = {}) => {
  /**
   * 默认小球数量
   */
  const defaultNum = 99
   ...
   * 绘制满屏小球
   */
  const drawCircleBall = (canvas: HTMLCanvasElement, num = defaultNum) => {
    /**
     * 设置 canvas 的 size
     */
